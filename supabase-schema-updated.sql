...
-- Generado desde Prisma Schema con actualizaciones de WhatsApp y moneda
...
(uuid_generate_v4(), 'Alimento Premium para Perros', 'Comida balanceada para perros adultos', 95.99, 50, (SELECT id FROM "sellers" WHERE storeName = 'Mascotas Felices'), (SELECT id FROM "product_categories" WHERE name = 'Alimentos para Mascotas')),
(uuid_generate_v4(), 'Juguete Interactivo para Gatos', 'Juguete con pluma y campana', 48.99, 30, (SELECT id FROM "sellers" WHERE storeName = 'Mascotas Felices'), (SELECT id FROM "product_categories" WHERE name = 'Accesorios')),
(uuid_generate_v4(), 'Cepillo para Mascotas', 'Cepillo de cerdas suaves para el cuidado del pelaje', 68.50, 25, (SELECT id FROM "sellers" WHERE storeName = 'Mascotas Felices'), (SELECT id FROM "product_categories" WHERE name = 'Salud y Cuidado'));

-- Servicios de ejemplo (precios en Soles Peruanos)
INSERT INTO "services" ("id", "name", "description", "price", "duration", "walkerId") VALUES
(uuid_generate_v4(), 'Paseo Básico', 'Paseo de 30 minutos por el parque', 55.00, 30, (SELECT id FROM "walkers" WHERE name = 'Carlos Rodríguez')),
(uuid_generate_v4(), 'Paseo Extendido', 'Paseo de 60 minutos con tiempo de juego', 92.50, 60, (SELECT id FROM "walkers" WHERE name = 'Carlos Rodríguez')),
(uuid_generate_v4(), 'Paseo Premium', 'Paseo de 90 minutos con entrenamiento básico', 148.00, 90, (SELECT id FROM "walkers" WHERE name = 'Carlos Rodríguez'));
