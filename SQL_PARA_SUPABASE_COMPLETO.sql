...
CREATE TABLE "notifications" (
    "id" UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    "userId" UUID NOT NULL,
    "type" VARCHAR(50) NOT NULL, -- ORDER_UPDATE, BOOKING_CONFIRMED, etc.
...
CREATE TABLE "banners" (
    ...
    "position" VARCHAR(50) NOT NULL, -- HOME, CATEGORY, PRODUCT, etc.
    "isActive" BOOLEAN DEFAULT true,
...
-- Tabla de Anuncios (Advertisements)
CREATE TABLE "advertisements" (
    "id" UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    "title" VARCHAR(255) NOT NULL,
    "description" TEXT,
    "image" TEXT NOT NULL, -- URL de la imagen
    "link" TEXT NOT NULL, -- URL de destino
    "advertiser" VARCHAR(255) NOT NULL, -- Nombre del anunciante
    "position" VARCHAR(50) NOT NULL, -- SIDEBAR, FOOTER, POPUP, etc.
    "isActive" BOOLEAN DEFAULT true,
    "startDate" TIMESTAMP WITH TIME ZONE,
    "endDate" TIMESTAMP WITH TIME ZONE,
    "budget" DECIMAL(10,2), -- Presupuesto del anuncio
    "spent" DECIMAL(10,2) DEFAULT 0.00, -- Gastado hasta ahora
    "clickCount" INTEGER DEFAULT 0, -- Contador de clicks
    "viewCount" INTEGER DEFAULT 0, -- Contador de vistas
    "createdAt" TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    "updatedAt" TIMESTAMP WITH TIME ZONE DEFAULT NOW()
...
CREATE TABLE "campaigns" (
    ...
    "startDate" TIMESTAMP WITH TIME ZONE,
    "endDate" TIMESTAMP WITH TIME ZONE,
    "targetAudience" JSONB, -- Audiencia objetivo
    "content" JSONB, -- Contenido de la campaña
    "budget" DECIMAL(10,2),
...
CREATE TABLE "user_analytics" (
    "id" UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    "userId" UUID,
    "sessionId" VARCHAR(255), -- ID de sesión
    "event" VARCHAR(100) NOT NULL, -- PAGE_VIEW, PRODUCT_VIEW, ADD_TO_CART, etc.
    "data" JSONB, -- Datos del evento
    "url" TEXT, -- URL donde ocurrió el evento
    "userAgent" TEXT, -- User Agent del navegador
    "ipAddress" INET, -- Dirección IP
    "createdAt" TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
CREATE TABLE "recommendations" (
    ...
    "serviceId" UUID,
    "walkerId" UUID,
    "score" DECIMAL(5,4) DEFAULT 0.0000, -- Puntuación de recomendación
...
CREATE TABLE "reports" (
    "id" UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    "reporterId" UUID NOT NULL, -- ID del usuario que reporta
    "reportedId" UUID NOT NULL, -- ID del usuario/reporte reportado
    "type" VARCHAR(50) NOT NULL, -- USER, PRODUCT, SERVICE, REVIEW, etc.
    "reason" VARCHAR(255) NOT NULL, -- SPAM, INAPPROPRIATE, FRAUD, etc.
    "description" TEXT NOT NULL,
    "status" "VerificationStatus" DEFAULT 'PENDING',
    "reviewedBy" UUID, -- ID del administrador que revisó
...
CREATE TABLE "support_conversations" (
    ...
    "assignedTo" UUID, -- ID del agente asignado
...
CREATE TABLE "support_messages" (
    ...
    "message" TEXT NOT NULL,
    "attachments" TEXT, -- JSON array de URLs de archivos adjuntos
    "isRead" BOOLEAN DEFAULT false,
    "createdAt" TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
CREATE TABLE "currency_settings" (
    ...
    "name" VARCHAR(50) NOT NULL, -- Sol, Dólar, etc.
...
CREATE TABLE "price_history" (
    ...
    "changedBy" UUID NOT NULL, -- ID del usuario que cambió el precio
...
CREATE TABLE "audit_logs" (
    ...
    "entityType" VARCHAR(50) NOT NULL, -- USER, PRODUCT, ORDER, etc.
